...
for gid, g_df in df.groupby(df.iloc[:, 0]):
...
r2_tr, rmse_tr, mae_tr = calc_metrics(y_train, best_rf.predict(X_train))
r2_te, rmse_te, mae_te = calc_metrics(y_test,  best_rf.predict(X_test))
